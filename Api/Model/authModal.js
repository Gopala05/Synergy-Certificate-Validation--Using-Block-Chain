...
const authSchema = new Mongoose.Schema({
  firstName: {
    type: String,
    required: [true, "Please provide your First Name!"], // Required, If not given trow the message
  },
  lastName: {
    type: String,
    required: [true, "Please provide your Last Name!"], // Required, If not given trow the message
  },
  authID: {
    type: String,
